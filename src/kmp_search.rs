...
mod tests {
    ...
    #[test]
    fn basic_find() {
        assert_eq!(find_str("hello world", "world"), vec![6]);
    }
    #[test]
    fn multiple_occurrences() {
        assert_eq!(find_str("ababab", "ab"), vec![0, 2, 4]);
    }
    #[test]
    fn no_match() {
        assert_eq!(find_str("hello", "xyz"), Vec::<usize>::new());
    }
    #[test]
    fn empty_pattern() {
        assert_eq!(find_str("hello", ""), vec![0]);
    }
    #[test]
    fn at_start() {
        assert_eq!(find_str("hello", "hello"), vec![0]);
    }
    #[test]
    fn overlap() {
        assert_eq!(find_str("aaaaa", "aa"), vec![0, 1, 2, 3]);
    }
    #[test]
    fn lps_basic() {
    ...
    fn pattern_longer_than_haystack() {
        assert_eq!(find_str("ab", "abc"), Vec::<usize>::new());
    }
    #[test]
    fn bytes_api() {
        assert_eq!(find(b"hello", b"ll"), vec![2]);
    }
}
