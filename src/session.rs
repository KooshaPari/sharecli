//! Terminal-session primitives shared by recovery and live I/O adapters.
//!
//! This module deliberately builds argument vectors instead of shell strings.  It is
//! safe to pass untrusted session names and terminal input through the adapter.
...
pub struct GhosttyCapabilities {
    ...
    /// Always false until Ghostty ships an authenticated native RPC endpoint.
