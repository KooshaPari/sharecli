...
impl Money {
    ...
    pub fn from_dollars(d: f64) -> Self {
        Self { cents: (d * 100.0).round() as i64 }
    }
    ...
    pub fn mul(&self, factor: f64) -> Money {
        Money { cents: (self.cents as f64 * factor).round() as i64 }
    }
...
mod tests {
    ...
    #[test]
    fn from_cents() {
        assert_eq!(Money::from_cents(1234).dollars(), 12.34);
    }
    #[test]
    fn from_dollars() {
        assert_eq!(Money::from_dollars(9.99).cents, 999);
    }
    #[test]
    fn add_sub() {
    ...
    #[test]
    fn fmt_small() {
        assert_eq!(fmt_usd(1234), "$12.34");
    }
    #[test]
    fn fmt_thousand() {
        assert_eq!(fmt_usd(1234567), "$12,345.67");
    }
    #[test]
    fn fmt_negative() {
        assert_eq!(fmt_usd(-5050), "-$50.50");
    }
}
