...
//!
//! ```
//! use sharecli::util::levenshtein::{distance, distance_with_cap, suggest_within};
//!
...
///
/// ```
/// use sharecli::util::levenshtein::distance;
///
...
///
/// ```
/// use sharecli::util::levenshtein::distance_with_cap;
///
...
///
/// ```
/// use sharecli::util::levenshtein::suggest_within;
///
