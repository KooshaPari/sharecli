...
mod tests {
    ...
    const RSA_PRIVATE: &str = include_str!("../tests/fixtures/jwt_test_rsa_private.pem");
    const RSA_PUBLIC_JWK: &str = include_str!("../tests/fixtures/jwt_test_jwks.json");
    ...
    fn jwt_auth() -> ServeAuth {
        let jwt = ServeJwtConfig {
            ...
            jwks_path: None,
            jwks: Some(RSA_PUBLIC_JWK.to_string()),
        };
