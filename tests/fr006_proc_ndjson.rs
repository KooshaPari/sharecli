...
#[test]
#[serial_test::serial]
#[ignore = "timing-dependent: fails under heavy CI load when proc cold-start > 5s; run manually with --ignored"]
...
#[test]
#[serial_test::serial]
#[ignore = "timing-dependent: fails under heavy CI load when proc cold-start > 3s; run manually with --ignored"]
