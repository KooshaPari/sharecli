...
Completed here: P0-P5's ShareCLI-side contracts and tests. P6-P8 remain open
because they require a Ghostty-side implementation and real macOS permission,
mount, crash, and restart validation.
