...
| C05 | L44 | Tray dashboard HTTP traceparent inject | Med | W14.1 · T-610 · FR-003 | Status: Closed | `src/tray_http.rs` · `src/dashboard.html` · `tests/c05_trace_tray_http_inject.rs` · `docs/ops/trace-multihop.md` | agent-c05 |
