...
| **2 — stub** | `docs/ops/agent-eval-harness.md` + optional `scripts/eval/agent-eval-stub.sh` | **Yes** | No (`continue-on-error`) |
...
| `docs/ops/agent-eval-harness.md` stub | Open (Phase 2) |
