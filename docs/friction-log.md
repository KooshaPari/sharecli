...
| 2026-07-10 | Tests | TRACEABILITY lists `fr002`–`fr005` files that are not on disk | FR-002..005 | High | Closed | T-200..T-230 |
| 2026-07-10 | Journeys | `docs/journeys/quick-start.md` still shows library `Client` snippet, not CLI | FR-001 / FR-002 | Med | Closed | T-240 + CLI rewrite + `tests/quick_start_journey.rs` |
