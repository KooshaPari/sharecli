...
**Weighted overall score:** 92.6% · **Overall grade:** A

(Unweighted mean of cluster pcts: (97+93+93+100+90+90+93+90+73+93+97+89)/12 = 1098/12 = **91.5% A**.)

(Tier-1 double-weight (C00–C03): (97+93+93+100)×2 + (90+90+93+90+73+93+97+89) = 766 + 715 = 1481 / 16 = **92.6% (A)**. Note: C07 lifted 90%→93% adds +3 to BOTH unweighted and tier-1 sums since C07 IS in tier-1.)
