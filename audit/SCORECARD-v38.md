...
**Commit audited:** `76e8f21` (Wave17 Plan 793 / **T-880 (C11 L111) DONE** post #782 merge — `src/commands/upgrade.rs` ships `UpgradeChannel` enum + soft probe; 6 FR-003 tests PASS in `tests/c11_l111_soft_upgrade.rs`; **NO** network egress). Earlier PRs in chain: #782 (this) / #781 Plan 782 (T-870, C05 L49) DONE / #780 Plan 776 att 2 (T-860, C04 L34) DONE / #777 Plan 778b (T-850, SLSA L3 re-pin) DONE / #776 Plan 777 (T-840, SLSA L2→L3) DONE / #775 T-810 (`--lib` pin 77.34% @ `fa887e9`, run `local-lib-20260827`); workspace pin **80.51%** @ `5d8dc08` retained as historical evidence. Final Wave17 score: weighted **92.0% A** · unweighted **91.0% A** · tier-1 **92.0% A**.
